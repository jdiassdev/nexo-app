<template>
    <AppLayout :title="`Presenças — ${subject.name}`" :nav-items="navItems">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6 lg:grid-cols-4">
            <div class="stat-card flex items-center gap-3" :class="overLimit ? 'ring-1 ring-red-200' : ''">
                <div class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" :class="overLimit ? 'bg-red-50' : 'bg-slate-100'">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold" :class="overLimit ? 'text-red-600' : 'text-slate-800'">
                        {{ total_absences }}
            ...
            <div class="stat-card flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800">{{ records.filter(r => r.present).length }}</p>
                </div>
            </div>
            <div v-if="overLimit" class="lg:col-span-2 flex items-center gap-2.5 bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-red-700 text-sm">
        ...
        <div class="page-card">
            <div class="px-5 py-3.5 border-b border-slate-100">
                <p class="text-sm font-semibold text-slate-800">Registros de Frequência</p>
            </div>
            <DataTable :value="records" class="text-sm" :rows="20" paginator>
                ...
                <Column header="Situação" style="width:140px">
                    <template #body="{ data }">
                        <span
                            ...
                            :class="data.present ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-600'"
                        >
                ...
                <template #empty>
                    <div class="flex flex-col items-center justify-center py-10 text-center">
                        <div class="w-10 h-10 rounded-2xl bg-slate-100 flex items-center justify-center mb-2">
